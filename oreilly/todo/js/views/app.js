...
app.AppView = Backbone.View.extend({
	...
	// Instead of generating a new element, bind to the exsiting
	// skeleton of the App already present in the HTML
	el: '#todoapp',

	// Our template for the lline of statistics at the bommot of the app.
	...
	initialize: function(){
		...
		this.listTo(app.Todos, 'add', this.addOne);
		this.listTo(app.Todos, 'reset', this.addAll);
	...
	// Todo model, persisting it to localStorage.
